...
Post.create!( heading: 'Lilac Breasted Roller',
    				  sub_heading: 'Kruger National Park',
    					body: 'The lilac-breasted roller (Coracias caudatus) is a member of the roller family of birds. It is widely distributed in sub-Saharan Africa and the southern Arabian Peninsula, preferring open woodland and savanna; it is largely absent from treeless places. Usually found alone or in pairs, it perches conspicuously at the tops of trees, poles or other high vantage points from where it can spot insects, lizards, scorpions, snails, small birds and rodents moving about at ground level.[2] Nesting takes place in a natural hole in a tree where a clutch of 2–4 eggs is laid, and incubated by both parents, who are extremely aggressive in defence of their nest, taking on raptors and other birds. During the breeding season the male will rise to great heights, descending in swoops and dives, while uttering harsh, discordant cries.
							...
							images: [lbr_images_1, lbr_images_2, lbr_images_3, lbr_images_4])
...
afe_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/AFE/afe2.jpg").open,
												 caption: 'Koos looking cool')
afe_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/AFE/afe3.jpg").open,
												 caption: 'Koos portrait')
afe_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/AFE/afe4.jpg").open,
												 caption: "Koos flying high")
# afe_images_5 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/AFE/afe5.jpg").open,
...
Post.create!( heading: 'African Fish Eagle',
    					...
    					images: [afe_images_1, afe_images_2, afe_images_3, afe_images_4])
...
bv_images_1 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/BV/BV1.jpg").open,
												 caption: 'Jan landing')
bv_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/BV/BV2.jpg").open,
												 caption: "Jan's younger brother")
bv_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/BV/BV3.jpg").open,
												 caption: 'Jan looking scary')
bv_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/BV/BV4.jpg").open,
												 caption: 'Jan patrolling')
# bv_images_5 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/BV/BV5.jpg").open,
...
Post.create!( heading: 'Bearded Vulture',
    					...
    					images: [bv_images_1, bv_images_2, bv_images_3, bv_images_4])
...
cbe_images_1 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/CBE/cbe1.jpg").open,
												 caption: 'Birds of a feather')
cbe_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/CBE/cbe2.jpg").open,
												 caption: 'Beauty in flight')
cbe_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/CBE/cbe3.jpg").open,
												 caption: 'Liking my mask?')
cbe_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/CBE/cbe4.jpg").open,
												 caption: "What's up?")
# cbe_images_5 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/CBE/cbe5.jpg").open,
...
Post.create!( heading: 'Carmine Bee Eater',
    					...
    					images: [cbe_images_1, cbe_images_2, cbe_images_3, cbe_images_4])
...
cbs_images_1 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/cbs/cbs1.jpg").open,
												 caption: 'Crimson beauty')
cbs_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/cbs/cbs2.jpg").open,
												 caption: 'Rare yellow form')
cbs_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/cbs/cbs3.jpg").open,
												 caption: 'Looking out')
cbs_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/cbs/cbs4.jpg").open,
												 caption: 'Dancing with pray')
# cbs_images_5 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/cbs/cbs5.jpg").open,
...
Post.create!( heading: 'Crimson(and yellow) Breasted Shrike',
    					...
    					images: [cbs_images_1, cbs_images_2, cbs_images_3, cbs_images_4])
...
bc_images_1 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/bc/bc1.jpg").open,
												 caption: 'Walking')
bc_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/bc/bc2.jpg").open,
												 caption: 'Still Walking')
bc_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/bc/bc3.jpg").open,
												 caption: 'Still Walking..')
bc_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/bc/bc4.jpg").open,
												 caption: 'Still Walking...')
# bc_images_5 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/bc/bc5.jpg").open,
# 												 caption: 'Still Walking....')
...
Post.create!( heading: 'Black Crake',
    					...
    					images: [bc_images_1, bc_images_2, bc_images_3, bc_images_4])
...
wkf_images_1 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/wkf/wkf1.jpg").open,
												 caption: 'Lazy Sunday')
wkf_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/wkf/wkf2.jpg").open,
												 caption: 'Rule of thirds')
wkf_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/wkf/wkf3.jpg").open,
												 caption: 'Moving in')
wkf_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/wkf/wkf4.jpg").open,
												 caption: "What's up?")
# wkf_images_5 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/wkf/wkf5.jpg").open,
...
Post.create!( heading: 'Woodlands Kingfisher',
    					...
    					images: [wkf_images_1, wkf_images_2, wkf_images_3, wkf_images_4])
...
sbs_images_1 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/sbs/sbs1.jpg").open,
												 caption: 'Lunch')
sbs_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/sbs/sbs2.jpg").open,
												 caption: 'Elegant')
sbs_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/sbs/sbs3.jpg").open,
												 caption: 'Hence the name')
sbs_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/sbs/sbs4.jpg").open,
												 caption: 'I need water')
# sbs_images_5 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/sbs/sbs5.jpg").open,
# 												 caption: 'Close up')
...
Post.create!( heading: 'Saddle Billed Stork',
    					...
    					images: [sbs_images_1, sbs_images_2, sbs_images_3, sbs_images_4])
...
tbw_images_1 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/tbw/tbw1.jpg").open,
												 caption: 'Good start')
tbw_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/tbw/tbw2.jpg").open,
												 caption: 'Almost there')
tbw_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/tbw/tbw3.jpg").open,
												 caption: "Hope you're almost done!")
tbw_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/tbw/tbw4.jpg").open,
												 caption: 'Hard work!')
# tbw_images_5 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/tbw/tbw5.jpg").open,
...
Post.create!( heading: 'Thick Billed Weaver',
    					...
    					images: [tbw_images_1, tbw_images_2, tbw_images_3, tbw_images_4])
...
bat_images_1 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/bat/bat1.jpg").open,
												 caption: 'Adult and Juvenile')
bat_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/bat/bat2.jpg").open,
												 caption: 'Close up')
bat_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/bat/bat3.jpg").open,
												 caption: 'Portrait')
bat_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/bat/bat4.jpg").open,
												 caption: 'Up where I belong')
# bat_images_5 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/bat/bat5.jpg").open,
# 												 caption: 'Waiting')
...
Post.create!( heading: 'Bateleur',
    					...
    					images: [bat_images_1, bat_images_2, bat_images_3, bat_images_4])
...
ybk_images_1 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/ybk/ybk1.jpg").open,
												 caption: 'Nice tree')
ybk_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/ybk/ybk2.jpg").open,
												 caption: 'Looking for pray')
ybk_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/ybk/ybk3.jpg").open,
												 caption: 'What?')
ybk_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/ybk/ybk4.jpg").open,
												 caption: 'Dinner soon')
# ybk_images_5 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/ybk/ybk5.jpg").open,
...
Post.create!( heading: 'Yellow Billed Kite',
    					...
    					images: [ybk_images_1, ybk_images_2, ybk_images_3, ybk_images_4])
...
asb_images_1 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/asb/asb1.jpg").open,
												 caption: 'Beaut!')
asb_images_2 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/asb/asb2.jpg").open,
												 caption: 'Looking for breakfast')
asb_images_3 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/asb/asb3.jpg").open,
												 caption: 'Rocky fishing')
asb_images_4 = Image.new( photo: Rails.root.join("/Users/Lood800/desktop/images/birds/asb/asb4.jpg").open,
...
Post.create!( heading: 'African Spoonbill',
    					...
    					images: [asb_images_1, asb_images_2, asb_images_3, asb_images_4])
