...
#   scenario "Clicking the 'Click here subscribe to my blog posts' link" do
#     expect(page).to have_link('Click here to subscribe to my blog posts', href: '/subscribers/new')
#   end
...
# 		expect(page).to have_content('Lodewicus Adriaanse')  
# 	end	
...
#   scenario "Contact page should have '082-875-6591' content" do
...
# 		expect(page).to have_content('Birds are awesome')  
# 	end	
